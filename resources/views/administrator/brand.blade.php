                    ...
                    <div class="card">
                        <a href="{{ route('categoryview', ['id' => str_replace(' ', '-', strtolower($item->type))]) }}">
                            <img class="card-img-top"
                                src="{{ file_exists('images/brands/' . strtolower($item->brand) . '.png') ? asset('images/brands/' . strtolower($item->brand) . '.png') : asset('images/brands/DEFAULT.png') }}">
                        </a>
                        <div class="card-body text-center">
                            <h5 class="card-title">
                                <a href="{{ route('categoryview', ['id' => str_replace(' ', '-', strtolower($item->brand))]) }}"
                                    class="text-dark">
                        ...
                        <div class="card-footer text-center">
                            <a href="{{ route('brandview', ['id' => str_replace(' ', '-', strtolower($item->brand))]) }}"
                                class="btn btn-sm btn-warning font-weight-bold" target="__blank">
                                <i class="fas fa-eye"></i>
                            </a>
                            <a href="{{ route('adminbrandedit', ['id' => $item->id]) }}"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-sm btn-dark">Add Brand</button>
